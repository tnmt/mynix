...
#   ];
{
  ...
  legacy = {
    ...
    # Unknown-origin ed25519 currently sitting in dahlia's manual
    # authorized_keys. We don't yet know which machine holds the
    # matching private key.
    # TODO: identify origin by checking each personal machine's
    # ~/.ssh/id_ed25519.pub. Then either move to hosts.<machine> or
    # revoke if no longer needed.
    unknown_ed25519 = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIEIvp9PeEFVc7pupvKgW3oe4uugSAj5M3pwh9sVNGB3k tnmt@unknown (origin TBD)";
  };
}
