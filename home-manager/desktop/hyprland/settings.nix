...
in
{
  wayland.windowManager.hyprland.settings = {
    source = [ "~/.config/hypr/99_autogenerated-*.conf" ];
    ...
    general = {
      ...
      gaps_out = 6;
      border_size = 1;
      "col.active_border" = "rgba(${hex theme.accent}ee) rgba(${hex theme.color5}ee) 45deg";
      "col.inactive_border" = "rgba(${hex theme.bg_highlight}80)";
