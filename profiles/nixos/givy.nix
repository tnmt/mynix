# NixOS profile: givy bundle.
# Wires per-instance givy user services to a Caddy reverse proxy at
# https://givy-<name>.lvh.me, with optional CA trust for the local root.
{
  config,
  lib,
  username,
