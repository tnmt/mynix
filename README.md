...
- AI coding agent tooling layered in `home-manager/devel/ai/` (CLI packages, Agent Skills under `~/.agents/skills`, agent-specific integrations, sops-backed API keys); skill sources are pinned as flake inputs
